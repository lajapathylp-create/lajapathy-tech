...
import { z } from 'zod';
import { Send, CheckCircle, Loader2, MapPin, Mail, Phone, ArrowUpRight, Linkedin } from 'lucide-react';
      ...
      <section ref={heroRef} className="pt-32 pb-16 md:pt-40 md:pb-24 relative overflow-hidden">
        ...
        <div className="container-wide relative z-10">
          ...
          >
            ...
            <span className="text-sm font-mono text-muted-foreground tracking-wider">CONTACT US</span>
          </motion.div>
          ...
          >
            Share your request. We’ll handle the design—fast, flexible, and on demand.
          </motion.p>
        </div>
      </section>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-8 border border-border bg-card/30">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      {...register('name')}
                      className={`w-full px-4 py-4 bg-background border-2 transition-colors focus:outline-none ${errors.name
                  ...
                  <div>
                    ...
                    <input
                      ...
                      type="email"
                      {...register('email')}
                      className={`w-full px-4 py-4 bg-background border-2 transition-colors focus:outline-none ${errors.email
                        ? 'border-destructive focus:border-destructive'
                        : 'border-border focus:border-accent'
                        }`}
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium mb-2">
                      Describe your request <span className="text-accent">*</span>
                    </label>
                    <textarea
                      id="message"
                      {...register('message')}
                      rows={5}
                      className={`w-full px-4 py-4 bg-background border-2 transition-colors focus:outline-none resize-none ${errors.message
                        ? 'border-destructive focus:border-destructive'
                        : 'border-border focus:border-accent'
                        }`}
                      placeholder="What do you need designed? Add details, links, or references."
                    />
                    {errors.message && (
