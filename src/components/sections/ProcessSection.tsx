...
import { Compass, Target, Palette, } from 'lucide-react';

const steps = [
  {
    number: '01',
    title: 'Subscribe',
    description: 'Choose a plan that fits your needs. No contracts, pause anytime.',
    icon: Compass,
  },
  {
    number: '02',
    title: 'Submit Requests',
    description: 'Add unlimited design requests via your dashboard. We prioritize and start immediately.',
    icon: Target,
  },
  {
    number: '03',
    title: 'Get Designs Delivered',
    description: 'Receive high-quality designs fast. Iterate, refine, and keep moving forward.',
    icon: Palette,
  },
];
...
export const ProcessSection = () => {
  ...
  return (
    <section id="process" ref={sectionRef} className="py-24 md:py-32 bg-transparent relative">
        ...
        <div className="mb-24 md:mb-32">
          ...
          <AnimatedLine>
            <h2 className="font-syne font-bold text-5xl md:text-7xl max-w-4xl tracking-tight leading-[0.9]">
              Start in minutes.<span className="text-accent"> <br />Scale as you go.</span>
            </h2>
          </AnimatedLine>
        </div>
